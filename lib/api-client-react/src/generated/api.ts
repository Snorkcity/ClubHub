...
import type {
  ...
  DevelopmentInternalSummary,
  DevelopmentPerson,
  DevelopmentReleaseResult,
  DevelopmentReportDraft,
  DevelopmentReportDraftInput,
  Event,
  EventCancelInput,
  EventDetail,
  EventInput,
 ...
 */
export const readNotification = async (notificationId: number, options?: RequestInit): Promise<void> => {

  return customFetch<void>(getReadNotificationUrl(notificationId),
  {
    ...options,
    method: 'POST'
...
export const getReadNotificationMutationOptions = <TError = ErrorType<NotFoundResponse>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof readNotification>>, TError,{notificationId: number}, TContext>, request?: SecondParameter<typeof customFetch>}
...
const {mutation: mutationOptions, request: requestOptions} = options ?
  ...
  return  { mutationFn, ...mutationOptions }}
    ...
    export type ReadNotificationMutationError = ErrorType<NotFoundResponse>

    /**
 * @summary Mark one notification as read
 */
export const useReadNotification = <TError = ErrorType<NotFoundResponse>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof readNotification>>, TError,{notificationId: number}, TContext>, request?: SecondParameter<typeof customFetch>}
 ): UseMutationResult<
...
export const getGetPushConfigUrl = () => {
  ...
  return `/api/notifications/push-config`
}

/**
 * @summary Get public web push configuration
 */
export const getPushConfig = async ( options?: RequestInit): Promise<PushConfig> => {
 ...
 */
export const deletePushSubscription = async (pushSubscriptionDelete: PushSubscriptionDelete, options?: RequestInit): Promise<void> => {
  ...
  return customFetch<void>(getDeletePushSubscriptionUrl(),
  {
    ...
    method: 'DELETE',
    headers: { 'Content-Type': 'application/json', ...options?.headers },
    body: JSON.stringify(pushSubscriptionDelete)
  }
);}
...
export const getDeletePushSubscriptionMutationOptions = <TError = ErrorType<unknown>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof deletePushSubscription>>, TError,{data: BodyType<PushSubscriptionDelete>}, TContext>, request?: SecondParameter<typeof customFetch>}
): UseMutationOptions<Awaited<ReturnType<typeof deletePushSubscription>>, TError,{data: BodyType<PushSubscriptionDelete>}, TContext> => {
...
const {mutation: mutationOptions, request: requestOptions} = options ?
      ...
      const mutationFn: MutationFunction<Awaited<ReturnType<typeof deletePushSubscription>>, {data: BodyType<PushSubscriptionDelete>}> = (props) => {
          const {data} = props ?? {};
  ...
  return  { mutationFn, ...mutationOptions }}
    ...
    export type DeletePushSubscriptionMutationBody = BodyType<PushSubscriptionDelete>
...
export const useDeletePushSubscription = <TError = ErrorType<unknown>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof deletePushSubscription>>, TError,{data: BodyType<PushSubscriptionDelete>}, TContext>, request?: SecondParameter<typeof customFetch>}
        ...
        TError,
        {data: BodyType<PushSubscriptionDelete>},
        TContext
      > => {
 ...
 */
export const updateNotificationPreferences = async (notificationPreferencesUpdate: NotificationPreferencesUpdate, options?: RequestInit): Promise<void> => {
 ...
 */
export const createTeamInvitation = async (teamInvitationInput: TeamInvitationInput, options?: RequestInit): Promise<TeamInvitationResult> => {
...
export const getPreviewTeamInvitationUrl = (params: PreviewTeamInvitationParams,) => {
  const normalizedParams = new URLSearchParams();
  ...
  return stringifiedParams.length > 0 ? `/api/team-invitations/preview?${stringifiedParams}` : `/api/team-invitations/preview`
}

/**
 * @summary Preview a team invitation
 */
export const previewTeamInvitation = async (params: PreviewTeamInvitationParams, options?: RequestInit): Promise<TeamInvitationPreview> => {

  return customFetch<TeamInvitationPreview>(getPreviewTeamInvitationUrl(params),
  {
    ...options,
    method: 'GET'
...
export const getPreviewTeamInvitationQueryKey = (params?: PreviewTeamInvitationParams,) => {
    return [
    `/api/team-invitations/preview`, ...(params ? [params] : [])
    ] as const;
    }


export const getPreviewTeamInvitationQueryOptions = <TData = Awaited<ReturnType<typeof previewTeamInvitation>>, TError = ErrorType<unknown>>(params: PreviewTeamInvitationParams, options?: { query?:UseQueryOptions<Awaited<ReturnType<typeof previewTeamInvitation>>, TError, TData>, request?: SecondParameter<typeof customFetch>}
) => {

const {query: queryOptions, request: requestOptions} = options ?? {};

  const queryKey =  queryOptions?.queryKey ?? getPreviewTeamInvitationQueryKey(params);



    const queryFn: QueryFunction<Awaited<ReturnType<typeof previewTeamInvitation>>> = ({ signal }) => previewTeamInvitation(params, { signal, ...requestOptions });





   return  { queryKey, queryFn, ...queryOptions} as UseQueryOptions<Awaited<ReturnType<typeof previewTeamInvitation>>, TError, TData> & { queryKey: QueryKey }
}

export type PreviewTeamInvitationQueryResult = NonNullable<Awaited<ReturnType<typeof previewTeamInvitation>>>
export type PreviewTeamInvitationQueryError = ErrorType<unknown>
...
export function usePreviewTeamInvitation<TData = Awaited<ReturnType<typeof previewTeamInvitation>>, TError = ErrorType<unknown>>(
 params: PreviewTeamInvitationParams, options?: { query?:UseQueryOptions<Awaited<ReturnType<typeof previewTeamInvitation>>, TError, TData>, request?: SecondParameter<typeof customFetch>}

 ):  UseQueryResult<TData, TError> & { queryKey: QueryKey } {

  const queryOptions = getPreviewTeamInvitationQueryOptions(params,options)
 ...
 */
export const acceptTeamInvitation = async (teamInvitationAcceptance: TeamInvitationAcceptance, options?: RequestInit): Promise<AcceptTeamInvitation200> => {

  return customFetch<AcceptTeamInvitation200>(getAcceptTeamInvitationUrl(),
  {
    ...options,
    method: 'POST',
    headers: { 'Content-Type': 'application/json', ...options?.headers },
    body: JSON.stringify(teamInvitationAcceptance)
  }
);}
...
export const getAcceptTeamInvitationMutationOptions = <TError = ErrorType<unknown>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof acceptTeamInvitation>>, TError,{data: BodyType<TeamInvitationAcceptance>}, TContext>, request?: SecondParameter<typeof customFetch>}
): UseMutationOptions<Awaited<ReturnType<typeof acceptTeamInvitation>>, TError,{data: BodyType<TeamInvitationAcceptance>}, TContext> => {
...
const {mutation: mutationOptions, request: requestOptions} = options ?
      ...
      const mutationFn: MutationFunction<Awaited<ReturnType<typeof acceptTeamInvitation>>, {data: BodyType<TeamInvitationAcceptance>}> = (props) => {
          const {data} = props ?? {};
  ...
  return  { mutationFn, ...mutationOptions }}
    ...
    export type AcceptTeamInvitationMutationBody = BodyType<TeamInvitationAcceptance>
...
export const useAcceptTeamInvitation = <TError = ErrorType<unknown>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof acceptTeamInvitation>>, TError,{data: BodyType<TeamInvitationAcceptance>}, TContext>, request?: SecondParameter<typeof customFetch>}
        ...
        TError,
        {data: BodyType<TeamInvitationAcceptance>},
        TContext
      > => {
...
export const getSaveDevelopmentReportDraftUrl = (cycleId: number,
    playerId: number,) => {




  return `/api/development-cycles/${cycleId}/players/${playerId}/report-draft`
}

/**
 * @summary Review the family-safe wording for one submitted assessment
 */
export const saveDevelopmentReportDraft = async (cycleId: number,
    playerId: number,
    developmentReportDraftInput: DevelopmentReportDraftInput, options?: RequestInit): Promise<DevelopmentReportDraft> => {

  return customFetch<DevelopmentReportDraft>(getSaveDevelopmentReportDraftUrl(cycleId,playerId),
  {
    ...options,
    method: 'PUT',
    headers: { 'Content-Type': 'application/json', ...options?.headers },
    body: JSON.stringify(developmentReportDraftInput)
  }
);}
...
export const getSaveDevelopmentReportDraftMutationOptions = <TError = ErrorType<unknown>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof saveDevelopmentReportDraft>>, TError,{cycleId: number;playerId: number;data: BodyType<DevelopmentReportDraftInput>}, TContext>, request?: SecondParameter<typeof customFetch>}
): UseMutationOptions<Awaited<ReturnType<typeof saveDevelopmentReportDraft>>, TError,{cycleId: number;playerId: number;data: BodyType<DevelopmentReportDraftInput>}, TContext> => {

const mutationKey = ['saveDevelopmentReportDraft'];
const {mutation: mutationOptions, request: requestOptions} = options ?
      options.mutation && 'mutationKey' in options.mutation && options.mutation.mutationKey ?
      options
      : {...options, mutation: {...options.mutation, mutationKey}}
      ...
      const mutationFn: MutationFunction<Awaited<ReturnType<typeof saveDevelopmentReportDraft>>, {cycleId: number;playerId: number;data: BodyType<DevelopmentReportDraftInput>}> = (props) => {
          const {cycleId,playerId,data} = props ?? {};

          return  saveDevelopmentReportDraft(cycleId,playerId,data,requestOptions)
        }
  ...
  return  { mutationFn, ...mutationOptions }}
    ...
    export type SaveDevelopmentReportDraftMutationResult = NonNullable<Awaited<ReturnType<typeof saveDevelopmentReportDraft>>>
    export type SaveDevelopmentReportDraftMutationBody = BodyType<DevelopmentReportDraftInput>
    export type SaveDevelopmentReportDraftMutationError = ErrorType<unknown>

    /**
 * @summary Review the family-safe wording for one submitted assessment
 */
export const useSaveDevelopmentReportDraft = <TError = ErrorType<unknown>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof saveDevelopmentReportDraft>>, TError,{cycleId: number;playerId: number;data: BodyType<DevelopmentReportDraftInput>}, TContext>, request?: SecondParameter<typeof customFetch>}
 ): UseMutationResult<
        Awaited<ReturnType<typeof saveDevelopmentReportDraft>>,
        TError,
        {cycleId: number;playerId: number;data: BodyType<DevelopmentReportDraftInput>},
        TContext
      > => {
      return useMutation(getSaveDevelopmentReportDraftMutationOptions(options));
    }
...
export const getGetDevelopmentInternalSummaryUrl = (cycleId: number,) => {




  return `/api/development-cycles/${cycleId}/internal-summary`
}

/**
 * @summary Restricted submitted-cycle team summary and prior-cycle changes
 */
export const getDevelopmentInternalSummary = async (cycleId: number, options?: RequestInit): Promise<DevelopmentInternalSummary> => {

  return customFetch<DevelopmentInternalSummary>(getGetDevelopmentInternalSummaryUrl(cycleId),
  {
    ...options,
    method: 'GET'
...
export const getGetDevelopmentInternalSummaryQueryKey = (cycleId: number,) => {
    return [
    `/api/development-cycles/${cycleId}/internal-summary`
    ] as const;
    }


export const getGetDevelopmentInternalSummaryQueryOptions = <TData = Awaited<ReturnType<typeof getDevelopmentInternalSummary>>, TError = ErrorType<unknown>>(cycleId: number, options?: { query?:UseQueryOptions<Awaited<ReturnType<typeof getDevelopmentInternalSummary>>, TError, TData>, request?: SecondParameter<typeof customFetch>}
) => {

const {query: queryOptions, request: requestOptions} = options ?? {};

  const queryKey =  queryOptions?.queryKey ?? getGetDevelopmentInternalSummaryQueryKey(cycleId);



    const queryFn: QueryFunction<Awaited<ReturnType<typeof getDevelopmentInternalSummary>>> = ({ signal }) => getDevelopmentInternalSummary(cycleId, { signal, ...requestOptions });





   return  { queryKey, queryFn, enabled: cycleId !== null && cycleId !== undefined, ...queryOptions} as UseQueryOptions<Awaited<ReturnType<typeof getDevelopmentInternalSummary>>, TError, TData> & { queryKey: QueryKey }
}

export type GetDevelopmentInternalSummaryQueryResult = NonNullable<Awaited<ReturnType<typeof getDevelopmentInternalSummary>>>
export type GetDevelopmentInternalSummaryQueryError = ErrorType<unknown>
...
export function useGetDevelopmentInternalSummary<TData = Awaited<ReturnType<typeof getDevelopmentInternalSummary>>, TError = ErrorType<unknown>>(
 cycleId: number, options?: { query?:UseQueryOptions<Awaited<ReturnType<typeof getDevelopmentInternalSummary>>, TError, TData>, request?: SecondParameter<typeof customFetch>}

 ):  UseQueryResult<TData, TError> & { queryKey: QueryKey } {

  const queryOptions = getGetDevelopmentInternalSummaryQueryOptions(cycleId,options)
