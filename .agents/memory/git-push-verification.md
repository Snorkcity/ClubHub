...
- Large trees can trigger connector/WAF HTML responses or durable-runtime replay errors. Upload blobs in small serial batches; if one notebook runtime becomes replay-corrupted, delegate the mechanical push to a fresh helper runtime.
